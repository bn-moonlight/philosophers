...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/12/08 02:07:37 by kdemirci          #+#    #+#             */
/*   Updated: 2023/07/26 02:15:00 by myagiz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef struct addion // filozofların kişisel bilgileri
{
	int				id;
	int				l_forkid;
	int				r_forkid;
...
typedef struct p_stk // tüm filzoların bilgileri
{
	int					id;
	int					must_eat;
	int					time_to_die;
